...
RSpec.describe RefereesController, :type => :controller do
  ...
  # Referee. As you add validations to Referee, be sure to
  ...
  # RefereesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all referees as @referees" do
      referee = Referee.create! valid_attributes
  ...
  describe "GET show" do
    it "assigns the requested referee as @referee" do
      referee = Referee.create! valid_attributes
      get :show, {:id => referee.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested referee as @referee" do
      referee = Referee.create! valid_attributes
      get :edit, {:id => referee.to_param}, valid_session
      expect(assigns(:referee)).to eq(referee)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Referee" do
        expect {
          post :create, {:referee => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved referee as @referee" do
        post :create, {:referee => invalid_attributes}, valid_session
        expect(assigns(:referee)).to be_a_new(Referee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested referee" do
        referee = Referee.create! valid_attributes
        put :update, {:id => referee.to_param, :referee => new_attributes}, valid_session
        referee.reload
      ...
      it "assigns the requested referee as @referee" do
        referee = Referee.create! valid_attributes
        put :update, {:id => referee.to_param, :referee => valid_attributes}, valid_session
        expect(assigns(:referee)).to eq(referee)
      end
    ...
    describe "with invalid params" do
      it "assigns the referee as @referee" do
        referee = Referee.create! valid_attributes
        put :update, {:id => referee.to_param, :referee => invalid_attributes}, valid_session
        expect(assigns(:referee)).to eq(referee)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested referee" do
      referee = Referee.create! valid_attributes
      expect {
        delete :destroy, {:id => referee.to_param}, valid_session
      }.to change(Referee, :count).by(-1)
    end
