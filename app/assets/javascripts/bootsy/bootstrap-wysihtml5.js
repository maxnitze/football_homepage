    ...
    Wysihtml5.prototype = {
        ...
        initInsertLink: function(toolbar) {
            ...
            var insertLink = function() {
                ...
                var linkHash = { href: url };
                if (!(url.indexOf(location.hostname) > -1 || url.indexOf('/') == 0)) {
                  linkHash['target'] = "_blank";
                  linkHash['rel'] = "nofollow";
                }

                self.editor.composer.commands.exec("createLink", linkHash);
            };
